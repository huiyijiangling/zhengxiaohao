...
# kkk=log2(kkk+1)
# boxplot(kkk,las=2)
#gset=AnnoProbe::geoChina('GSE84433')
load("./GSE84433_eSet.Rdata")#log不平，但像是弄过了
...
#
library(DescTools)
genes_expr_mad_GSE84433=t(RobScale(t(genes_expr_with_clinical)))
genes_expr_mean_GSE84433=t(scale(t(genes_expr_with_clinical)))
probes_expr_GSE84433=probes_expr
phenoDat_GSE84433=phenoDat

save(genes_expr_mad_GSE84433,genes_expr_mean_GSE84433,probes_expr_GSE84433,phenoDat_GSE84433,file="GSE84433_after_bioc.Rdata")
write.csv(phenoDat_GSE84433,file="phenoDat_GSE84433.csv",quote = T)
#
if(eSet@annotation=="GPL570"){
  system("tar -xvf ./GSE84433/GSE84433_RAW.tar -C ./GSE84433/")
  celFiles <- list.celfiles('./GSE84433/',full.name=TRUE,listGzipped = T)
  ...
  #
  GSE84433_outcome=read_xls("./GSE84433/GSE84433_outcome.xls",col_names = TRUE)
  GSE84433_outcome=as.data.frame(GSE84433_outcome)
  GSE84433_outcome=GSE84433_outcome[-which(substr(GSE84433_outcome$`GSM ID`,1,1)=="*"),]
  
  save(file="GSE84433_after.Rdata",probes_expr,phenoDat,probes_expr_rma,phenoDat_rma,GSE84433_outcome)
}
#
pdf("GSE84433_boxplot.pdf",width=100)
par(mfrow = c(2,1));
boxplot(probes_expr,las=2)
