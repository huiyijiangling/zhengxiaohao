...
TcgaTargetGTEX_phenotype_Pancreas624CDKN2B1=subset(TcgaTargetGTEX_phenotype_Pancreas624,TcgaTargetGTEX_phenotype_Pancreas624$sample_type %in% "SolidTissueNormal")
TcgaTargetGTEX_phenotype_Pancreas624CDKN2B1=subset(TcgaTargetGTEX_phenotype_Pancreas624CDKN2B1,TcgaTargetGTEX_phenotype_Pancreas624CDKN2B1$`_study` %in% "TCGA")
TcgaTargetGTEX_phenotype_Pancreas624CDKN2B2=subset(TcgaTargetGTEX_phenotype_Pancreas624,TcgaTargetGTEX_phenotype_Pancreas624$sample_type %in% "PrimaryTumor")
CDKN2Btxt=read.csv(file="CDKN2B.csv",skip = 0)

TcgaTargetGTEX_phenotype_Pancreas624CDKN2B2=subset(TcgaTargetGTEX_phenotype_Pancreas624CDKN2B2,rownames(TcgaTargetGTEX_phenotype_Pancreas624CDKN2B2) %in%
                                                     CDKN2Btxt$Sample.Id)
TcgaTargetGTEX_phenotype_Pancreas624CDKN2B2$Sample.Id=rownames(TcgaTargetGTEX_phenotype_Pancreas624CDKN2B2)
TcgaTargetGTEX_phenotype_Pancreas624CDKN2B2=merge(TcgaTargetGTEX_phenotype_Pancreas624CDKN2B2,CDKN2Btxt)
rownames(TcgaTargetGTEX_phenotype_Pancreas624CDKN2B2)=TcgaTargetGTEX_phenotype_Pancreas624CDKN2B2$Sample.Id
TcgaTargetGTEX_phenotype_Pancreas624CDKN2B2$cnv=TcgaTargetGTEX_phenotype_Pancreas624CDKN2B2$CDKN2B..Putative.copy.number.alterations.from.GISTIC
TcgaTargetGTEX_phenotype_Pancreas624CDKN2B2=TcgaTargetGTEX_phenotype_Pancreas624CDKN2B2[,-1]
TcgaTargetGTEX_phenotype_Pancreas624CDKN2B2=TcgaTargetGTEX_phenotype_Pancreas624CDKN2B2[,-(8:11)]
TcgaTargetGTEX_phenotype_Pancreas624CDKN2B1$cnv="Normal"
TcgaTargetGTEX_phenotype_Pancreas624=rbind(TcgaTargetGTEX_phenotype_Pancreas624CDKN2B1,TcgaTargetGTEX_phenotype_Pancreas624CDKN2B2)
...
box=box[,-(1:7)]
write.csv(box,file="CDKN2B deletion or not 4para.csv",quote=T)
box=TcgaTargetGTEX_phenotype_Pancreas624
# box$cnv=ifelse(TcgaTargetGTEX_phenotype_Pancreas624$cnv=="PrimaryTumor",'tumor','normal')
box=cbind(box,t(rnaCountslog21_Pancreas))
box=box[,-(1:7)]
pdf('Figure A.Boxplot of CDKN2B 4para.pdf',width = 8,height=4)
if(require('ggpubr')){
  library(ggpubr)
  ...
  p <- ggboxplot(box, x = "cnv", y = "ENSG00000147883",
    ...
    labs(title="",x="CDKN2B", y = "Expression")+#tag="ENSG00000000003"
...
pdf('Figure A.Boxplot of MLLT3 baed on status of CDKN2B 4para.pdf',width = 8,height=4)
if(require('ggpubr')){
  library(ggpubr)
  # google search : ggpubr boxplot add p-value
  # http://www.sthda.com/english/articles/24-ggpubr-publication-ready-plots/76-add-p-values-and-significance-levels-to-ggplots/
...
pdf('Figure A.Boxplot of MIR31HG baed on status of CDKN2B 4para.pdf',width = 8,height=4)
if(require('ggpubr')){
  library(ggpubr)
  # google search : ggpubr boxplot add p-value
  # http://www.sthda.com/english/articles/24-ggpubr-publication-ready-plots/76-add-p-values-and-significance-levels-to-ggplots/
