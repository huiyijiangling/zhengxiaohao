...
# kkk=log2(kkk+1)
# boxplot(kkk,las=2)
# gset=AnnoProbe::geoChina('GSE130563')
gset=getGEO('GSE130563',getGPL = F)
save(gset,file="GSE130563_eSet.Rdata")
load("./GSE130563_eSet.Rdata")#log不平，但像是弄过了
...
phenoDat <- pData(eSet)
head(phenoDat[,1:4])
write.csv(phenoDat,file="phenoDat_GSE130563.csv",quote = T)
