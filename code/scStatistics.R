...
runScStatistics <- function(dataPath, savePath,
    ...
    filter.thres <- list(
        ...
        Low.threshold = c(200, 200, -Inf, -Inf, -Inf),#单核100,单细胞两百
        High.threshold = c(10000,#cell.threshold$nUMI,10000 for sc
                           6000,#cell.threshold$nGene,
                           0.2,#cell.threshold$mito.percent
                           2,#cell.threshold$ribo.percent
                           0.2)#cell.threshold$diss.percent
    )
