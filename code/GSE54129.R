...
#
#read_xls处理预后信息 没有
# phenoDat_outcome=read.csv("./GSE54129/GSE54129_outcome.csv",header = T)
...
genes_expr_GSE54129_rna=genes_expr_with_clinical
phenoDat_GSE54129_rna=phenoDat
probes_expr_GSE54129_rna=probes_expr
genes_expr_mad_GSE54129_rna=t(RobScale(t(genes_expr_with_clinical)))
genes_expr_mean_GSE54129_rna=t(scale(t(genes_expr_with_clinical)))
#
...
genes_expr_with_clinical=genes_expr[,which(colnames(genes_expr) %in% phenoDat$geo_accession)]
dim(genes_expr_with_clinical)
phenoDat_GSE54129_mir=phenoDat
probes_expr_GSE54129_mir=probes_expr
genes_expr_GSE54129_mir=genes_expr_with_clinical
genes_expr_mad_GSE54129_mir=t(RobScale(t(genes_expr_with_clinical)))#可以进行NA检验
genes_expr_mean_GSE54129_mir=t(scale(t(genes_expr_with_clinical)))
...
#手动检验错误
#手动检验错误
phenoDat_GSE54129_rna["GSM1015737","title"]="pancreatic ductal adenocarcinoma - Patient Sample 09"

# 合并为了留下统一用户
phenoDat_GSE54129_mir=phenoDat_GSE54129_mir[phenoDat_GSE54129_mir$title %in% phenoDat_GSE54129_rna$title,]
genes_expr_GSE54129_mir=genes_expr_GSE54129_mir[,which(colnames(genes_expr_GSE54129_mir) %in% phenoDat_GSE54129_mir$geo_accession)]
phenoDat_GSE54129_rna=phenoDat_GSE54129_rna[phenoDat_GSE54129_rna$title %in% phenoDat_GSE54129_mir$title,]
genes_expr_GSE54129_rna=genes_expr_GSE54129_rna[,which(colnames(genes_expr_GSE54129_rna) %in% phenoDat_GSE54129_rna$geo_accession)]

#
save(phenoDat_GSE54129_mir,probes_expr_GSE54129_mir,genes_expr_mad_GSE54129_mir,genes_expr_mean_GSE54129_mir,genes_expr_GSE54129_mir,
     phenoDat_GSE54129_rna,probes_expr_GSE54129_rna,genes_expr_mad_GSE54129_rna,genes_expr_mean_GSE54129_rna,genes_expr_GSE54129_rna,
     file="GSE54129_after_soft.Rdata")
#(file="GSE54129_after_bioc.Rdata"))
# write.csv(phenoDat_GSE54129,file="phenoDat_GSE54129.csv",quote = T)
