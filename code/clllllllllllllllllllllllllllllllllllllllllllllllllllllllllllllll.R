...
e=t(exprSet[c('ENSG00000015475','ENSG00000149658','ENSG00000184992'),])
e=log2(e+1)
colnames(e)=c('ENSG00000015475','ENSG00000149658','ENSG00000184992')
dat=cbind(phe,e)
...
colnames(dat) 
s=Surv(time, event) ~ ENSG00000015475+ENSG00000196236
