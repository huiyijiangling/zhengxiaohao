...
# kkk=log2(kkk+1)
# boxplot(kkk,las=2)
#gset=AnnoProbe::geoChina('GSE34942')
...
system("tar -xvf ./GSE34942/GSE34942_RAW.tar -C ./GSE34942/")
celFiles <- list.celfiles('./GSE34942/',full.name=TRUE,listGzipped = T)
...
#
GSE34942_outcome=read_xls("./GSE34942/GSE34942_outcome.xls",col_names = TRUE)
GSE34942_outcome=as.data.frame(GSE34942_outcome)
GSE34942_outcome=GSE34942_outcome[-which(substr(GSE34942_outcome$`GSM ID`,1,1)=="*"),]
pdf("GSE34942_boxplot.pdf",width=100)
par(mfrow = c(2,1));
boxplot(probes_expr,las=2)
boxplot(probes_expr_rma,las=2)
dev.off()
save("GSE34942_after.Rdata",probes_expr,phenoDat,probes_expr_rma,_rma,GSE34942_outcome)
# }
??rlogTransformation
normalize.method()
bgcorrect.methods()
