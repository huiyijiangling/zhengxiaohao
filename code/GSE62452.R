...
# kkk=log2(kkk+1)
# boxplot(kkk,las=2)
#gset=AnnoProbe::geoChina('GSE62452')
load("./GSE62452_eSet.Rdata")#log不平，但像是弄过了
...
if(eSet@annotation=="GPL570"){
  system("tar -xvf ./GSE62452/GSE62452_RAW.tar -C ./GSE62452/")
  celFiles <- list.celfiles('./GSE62452/',full.name=TRUE,listGzipped = T)
  ...
  dim(probes_expr_rma)
  #
  pdf("GSE62452_boxplot.pdf",width=100)
  par(mfrow = c(2,1));
  boxplot(probes_expr,las=2)
...
#
#read_xls处理预后信息 没有
# phenoDat_outcome=read.csv("./GSE62452/GSE62452_outcome.csv",header = T)
...
genes_expr_GSE62452_rna=genes_expr_with_clinical
phenoDat_GSE62452_rna=phenoDat
probes_expr_GSE62452_rna=probes_expr
genes_expr_mad_GSE62452_rna=t(RobScale(t(genes_expr_with_clinical)))
genes_expr_mean_GSE62452_rna=t(scale(t(genes_expr_with_clinical)))

phenoDat_GSE62452_rna["GSM1015737","title"]="pancreatic ductal adenocarcinoma - Patient Sample 09"
#我觉得不用删掉，只是缺东西而已。全删除就是97个、


#
save(phenoDat_GSE62452_mir,probes_expr_GSE62452_mir,genes_expr_mad_GSE62452_mir,genes_expr_mean_GSE62452_mir,genes_expr_GSE62452_mir,
     phenoDat_GSE62452_rna,probes_expr_GSE62452_rna,genes_expr_mad_GSE62452_rna,genes_expr_mean_GSE62452_rna,genes_expr_GSE62452_rna,
     file="GSE62452_after_soft.Rdata")
#(file="GSE62452_after_bioc.Rdata"))
write.csv(phenoDat,file="phenoDat.csv",quote = T)
pdf("GSE62452_mad.pdf",width = 100)
par(mfrow = c(2,1));
boxplot(probes_expr)
