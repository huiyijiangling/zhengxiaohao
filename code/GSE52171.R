...
# kkk=log2(kkk+1)
# boxplot(kkk,las=2)
# gset=AnnoProbe::geoChina('GSE52171')
# gset=getGEO('GSE52171',getGPL = F)
# save(gset,file="GSE52171_eSet.Rdata")
load("./GSE52171_eSet.Rdata")#log不平，但像是弄过了
...
phenoDat <- pData(eSet)
head(phenoDat[,1:4])
write.csv(phenoDat,file="phenoDat_GSE52171.csv",quote = T)
