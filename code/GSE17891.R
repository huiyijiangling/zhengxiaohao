...
# kkk=log2(kkk+1)
# boxplot(kkk,las=2)
#gset=AnnoProbe::geoChina('GSE17891')
load("./GSE17891_eSet.Rdata")#log不平，但像是弄过了
...
if(eSet@annotation=="GPL570"){
  system("tar -xvf ./GSE17891/GSE17891_RAW.tar -C ./GSE17891/")
  celFiles <- list.celfiles('./GSE17891/',full.name=TRUE,listGzipped = T)
  ...
  dim(probes_expr_rma)
  #
  pdf("GSE17891_boxplot.pdf",width=100)
  par(mfrow = c(2,1));
  boxplot(probes_expr,las=2)
...
#
#read_xls处理预后信息
phenoDat_outcome=read.csv("./GSE17891/GSE17891_outcome.csv",header = T)
...
#
library(DescTools)
genes_expr_mad_GSE17891=t(RobScale(t(genes_expr_with_clinical)))
genes_expr_mean_GSE17891=t(scale(t(genes_expr_with_clinical)))
probes_expr_GSE17891=probes_expr
phenoDat_GSE17891=phenoDat
save(genes_expr_mad_GSE17891,genes_expr_mean_GSE17891,probes_expr_GSE17891,phenoDat_GSE17891,file="GSE17891_after_bioc.Rdata")
write.csv(phenoDat_GSE17891,file="phenoDat_GSE17891.csv",quote = T)
pdf("GSE17891_mad.pdf",width = 100)
par(mfrow = c(2,1));
