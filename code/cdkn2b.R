...
box=box[,-(1:7)]
write.csv(box,file="CDKN2B deletion or not.csv",quote=T)
box=TcgaTargetGTEX_phenotype_Pancreas624
# box$cnv=ifelse(TcgaTargetGTEX_phenotype_Pancreas624$cnv=="PrimaryTumor",'tumor','normal')
box=cbind(box,t(rnaCountslog21_Pancreas))
box=box[,-(1:7)]
pdf('Figure A.Boxplot of CDKN2B.pdf',width = 8,height=4)
if(require('ggpubr')){
  library(ggpubr)
...
pdf('Figure A.Boxplot of MLLT3 baed on status of CDKN2B.pdf',width = 8,height=4)
if(require('ggpubr')){
  library(ggpubr)
  # google search : ggpubr boxplot add p-value
  # http://www.sthda.com/english/articles/24-ggpubr-publication-ready-plots/76-add-p-values-and-significance-levels-to-ggplots/
...
pdf('Figure A.Boxplot of MIR31HG baed on status of CDKN2B.pdf',width = 8,height=4)
if(require('ggpubr')){
  library(ggpubr)
  # google search : ggpubr boxplot add p-value
  # http://www.sthda.com/english/articles/24-ggpubr-publication-ready-plots/76-add-p-values-and-significance-levels-to-ggplots/
